    ...
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 border border-violet-500/30 bg-violet-500/10 text-violet-300 text-xs font-medium px-3.5 py-1.5 rounded-full mb-8">
          ...
          4.1/5 rating · Trusted by 10,000+ developers
        </div>
        ...
        <p className="mt-6 text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
          Stop waiting for the backend. Intercept network requests, write
          dynamic JavaScript responses, and simulate latency — entirely locally.
        </p>
