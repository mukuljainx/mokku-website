...
export const Footer = () => {
    return (
        <footer
            id="support"
            className="border-t border-white/5 bg-background/80 mt-8"
        >
            <div className="container mx-auto px-6 py-14">
                <div className="grid gap-10 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 leading-relaxed">
                            A free, open-source Chrome DevTools extension for
                            mocking API calls — with zero telemetry and full
                            local storage.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mb-4 leading-relaxed">
                            Mokku is free to use. If it saves you time, consider
                            buying a coffee or supporting via UPI.
                        </p>
                ...
                <div className="border-t border-white/5 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
                    <p className="text-xs text-slate-600">
                        &copy; {new Date().getFullYear()} Mokku. Open source
                        under MIT.
                    </p>
                    <a
