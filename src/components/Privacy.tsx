          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-slate-400 leading-relaxed mb-4">
                Mokku collects{" "}
                <span className="text-white font-medium">zero telemetry</span>{" "}
                and does not track personal information of any kind. All mocks,
                headers, and project configurations are stored exclusively in
                your browser's{" "}
              ...
              <p className="text-slate-400 leading-relaxed">
                No accounts. No sign-up. No analytics. Just a tool that works
                exactly as expected, with full respect for your privacy.
              </p>
            </div>
